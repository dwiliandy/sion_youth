...
class MemberDataController extends Controller
{
  public function __construct()
  {
    ...
    public function index(){
      $member_datas = MemberData::select('group as kolom', 'name', 'birth_date','birth_place','family_name', 'baptize','sidi', 'sex','id_number','id','is_active')->orderByRaw('CONVERT(kolom, SIGNED) asc')->get();
