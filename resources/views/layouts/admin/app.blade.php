...
<head>
    ...
    <link
        href="{{ asset('admin_template') }}/https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body"><h5 class="modal-title text-center" id="exampleModalLabel">Yakin untuk keluar?</h5></div>
                  <div class="row">
                    <div class="col-md-12 text-center">
                      <button class="btn btn-secondary m-2" type="button" data-dismiss="modal">Cancel</button>  
                      <a class="btn btn-primary m-2" href="{{ route('logout') }}" onclick="event.preventDefault();
