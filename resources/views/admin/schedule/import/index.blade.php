      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-lg-6 my-2">
            <a class= "btn btn-success" href="{{ route('download-schedule') }}" ><i class="fas fa-download"> Download Template Excel</i></a>
          </div>
        </div>
        <div class="row">
          <div class="col-12">
          ...
          <div class="col-12">
            <ul style ="color: red">
              <li>Pastikan tanggal di Excel format text dengan DD/MM/YYYY</li>
              <li>Pastikan waktu di Excel format text dengan HH:MM</li>
            </ul>
          </div>
        </div>
        <form action="{{ route('import_schedule') }}" method="POST" enctype="multipart/form-data">
          @csrf
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                @enderror
                <input type="hidden" name="sector" class="form-control" value={{ $sector }}>
